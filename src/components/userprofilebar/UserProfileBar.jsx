...
const UserProfileBar = () => {
  ...
  return (
    <Container sx={{backgroundColor: "white",  borderRadius: "8px", borderBottomLeftRadius: "0px" , borderBottomRightRadius: "0px", paddingBottom: "20px", width: "90%", marginLeft: "90px"}}>
        ...
        <Box sx={{width: "450px", display: "flex", padding: '10px', paddingTop: "20px", flexDirection: {xs: "column", sm: "row", md: "row", lg: "row"}}}>
        ...
        <Box sx={{width: {xs: "180px", sm: "250px", md: "420px", lg: "420px"}, paddingTop: "30px"}}>
