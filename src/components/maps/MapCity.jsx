...
const MapCity = () => {
  return (
    <Container sx={{marginTop: "20px", backgroundColor: "white", padding: "40px", borderRadius: '12px', minWidth: '100%', display: "flex", flexDirection: "column", alignItems: "center"}}>
          ...
          <Box sx={{minWidth: "90%", display: "flex", justifyContent: "flex-start", marginBottom: '10px', }}>
        ...
        <Container sx={{marginTop: "20px", display: "flex", justifyContent: {xs: "center", sm: 'flex-end', md: 'flex-end', lg: 'flex-end', xl: 'flex-end'}, gap: '10px', width: {xs: "100%", sm: "100%", md: "100%", lg: "80%"}}}>
