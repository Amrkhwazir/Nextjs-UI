...
<Image src={"/images/Line2.png"} width={950} height={1} />
</Box>
<Box sx={{padding: "10px", display: "flex", justifyContent: "center", position: "relative"}}>
<Image src={"/images/Rectangle12.png"} width={950} height={250} />
<img style={{position: "absolute", width: "920px", bottom: "130px", left: "50px"}} src="/images/Line1.png" alt="" />
<img style={{position: "absolute", width: "840px", bottom: "60px", left: "130px"}} src="/images/vector.png" alt="" />
<ul>
    <li style={{position: "absolute", top: "20px", left: "30px", listStyle: "none", fontWeight: "bold"}}>300 <br /> bpm</li>
    <li style={{position: "absolute", top: "90px", left: "30px", listStyle: "none", fontWeight: "bold"}}>100 <br /> bpm</li>
    <li style={{position: "absolute", bottom: "10px", left: "30px", listStyle: "none", fontWeight: "bold"}}>0 <br /> bpm</li>
</ul>
</Box>
